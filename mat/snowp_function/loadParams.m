...
% Simulation parameters 
    ...
    p.addParameter('personal_name','',@ischar);
    p.addParameter('numthetaphi', '', @ischar);
...
% Simulation
    ...
    simulation.run_name = [p.Results.cell_model_name '_' simulation.model_name]; % for tmp data folder, ['a' 'b']
    % Simulation parameters
    ...
    simulation.numthetaphi = p.Results.numthetaphi;
    simulation.personal_name = p.Results.personal_name;
    % set temperature
